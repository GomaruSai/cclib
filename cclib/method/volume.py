                    ...
                    for xval in enumerate(x):
                        for yval in enumerate(y):
                            for zval in enumerate(z):                    
                                if(xval == x[-1]):
                                    der_x[xval] = (func[func.origin[0], yval, zval] - func[xval, yval, zval]) / func.spacing[0]
                                if(yval == y[-1]):
                                    der_y[xval] = (func[xval, func.origin[1], zval] - func[xval, yval, zval]) / func.spacing[1]
                                if(zval == z[-1]):                        
                                    der_z[zval] = (func[xval, yval, func.origin[2]] - func[xval, yval, zval]) / func.spacing[2]
                                else:
