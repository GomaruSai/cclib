...
def getAngle(coords0, coords1, coords2):
    ...
    return numpy
    math.acos(((coords1[0]**2 + coords1[1]**2 + coords1[2]**2) - (((coords0[0] + coords2[0]) * coords1[0]) + ((coords0[1] + coords2[1]) * coords1[1]) + ((coords0[2] + coords2[2]) * coords1[2]))) / (getDistance(coords0, coords1) * getDistance(coords1, coords2)))
